...
color morado, dorado, fondo, blanco; // Declarar colores a usar.
...
void setup() { 
  ...
  fondo = color(0, 0, 0); // se declara el rgb de fondo.
...
void draw() {
  ...
  figura1(100, width*0.5, height/2, morado, dorado, fondo); /* llama al void de la
   figura1 declarada abajo.*/
  nuclear(50, width*0.75, height/2, morado, dorado);/* llama al void de nuclear
   declarada abajo.*/
  figura2(150, width*0.25, height/2, morado, dorado, fondo);/* llama al void de la
